...
cliente = Cliente(contents['tipo'], contents['numero'], contents['nombre'], contents['apellido'], contents['dni'],
                  direccion['calle'], direccion['numero'], direccion['ciudad'], direccion['provincia'], direccion['pais'])
